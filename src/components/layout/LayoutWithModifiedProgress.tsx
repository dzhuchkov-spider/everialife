...
import NewProgressBarModified from '../ui/NewProgressBarModified';

interface LayoutWithModifiedProgressProps {
...
const LayoutWithModifiedProgress: React.FC<LayoutWithModifiedProgressProps> = ({ 
  children, 
  title = 'Ввод договора',
  showProgress = true,
  steps
  ...
  return (
    <div className="w-full min-h-screen bg-white flex flex-col font-[var(--font-helvetica)] relative">
      ...
      <main className="flex-1 flex flex-col gap-8 px-4 sm:px-6 lg:px-[156px] py-8 lg:py-10">
        ...
        {showProgress && <div className="hidden sm:block"><NewProgressBarModified steps={displaySteps} progress={currentProgress} /></div>}
...
export default LayoutWithModifiedProgress;
