...
interface NewProgressBarStep8Props {
  steps: Step[];
  progress?: number; // Progress value (0-100) or step number with fraction (e.g., 2.5)
}

const NewProgressBarStep8: React.FC<NewProgressBarStep8Props> = ({ steps, progress = 0 }) => {
  // Show only first 5 steps for Step8
  if (steps.length < 5) {
    return null;
  }
    ...
    <div className="relative w-full">
      ...
      <div className="relative w-full h-[50px]">
        ...
        <div className="relative z-20 flex justify-between w-full px-5">
          ...
          {/* Step 3 - Circle + Text Container - Modified: same design as step 2 */}
          <div className="flex flex-col items-center relative">
            <div className="bg-[#b47a59] rounded-[99px] shrink-0 size-[25px] flex items-center justify-center">
              <img src={checkIcon} alt="check" className="w-[16px] h-[16px]" />
            </div>
          ...
          {/* Step 4 - Circle + Text Container - Modified: border color #C4703E */}
          <div className="flex flex-col items-center relative">
            <div className="bg-white border-2 border-[#C4703E] border-solid rounded-[99px] shrink-0 size-[25px] flex items-center justify-center">
          ...
          {/* Step 5 - Circle + Text Container - Modified: border color #C4703E */}
          <div className="flex flex-col items-center relative">
            <div className="bg-white border-2 border-[#C4703E] border-solid rounded-[99px] shrink-0 size-[25px] flex items-center justify-center">
              <div className="flex flex-col font-['HelveticaNeueCyr:Roman',sans-serif] h-[16px] justify-center leading-[0] not-italic text-[16px] text-[#191919] text-center tracking-[0.5px] w-[24px]">
...
export default NewProgressBarStep8;
